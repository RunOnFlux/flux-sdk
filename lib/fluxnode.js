...
function getFluxNodePublicKey(fluxnodePrivateKey) {
...
function startFluxNodev6(collateralOutHash, collateralOutIndex, collateralPrivateKey, fluxnodePrivateKey, timestamp, compressedCollateralPrivateKey = true, redeemScript) {
  ...
  const fluxnodePublicKey = getFluxNodePublicKey(fluxnodePrivateKey);
...
function startFluxNode(collateralOutHash, collateralOutIndex, collateralPrivateKey, fluxnodePrivateKey, timestamp, compressedCollateralPrivateKey = true, redeemScript) {
  if (redeemScript) {
    // p2sh nodes, use v6
    const startFluxNodev6Result = startFluxNodev6(collateralOutHash, collateralOutIndex, collateralPrivateKey, fluxnodePrivateKey, timestamp, compressedCollateralPrivateKey, redeemScript);
